...
//       // TODO: Necesitamos el ID de la playlist recién creada para agregar la canción
//       // Por ahora, solo creamos la playlist y cerramos el modal
//       // El usuario puede volver a abrir el modal y seleccionar la nueva playlist
...
//                 {playlists.length > 0 && !showCreateForm && <span>o</span>}
//               </div>
